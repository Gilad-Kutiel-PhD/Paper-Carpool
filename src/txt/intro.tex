...
we consider the special (directed) variant of the problem, 
when for every directed edge, in the given graph, 
the antisymmetric edge also exists, as the undirected variant}.
