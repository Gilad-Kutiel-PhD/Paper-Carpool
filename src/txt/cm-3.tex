...
\For{every connected component $C_i = (V^i, E^i) \in G'$}{	
	$T \leftarrow \text{maximum spanning tree of } C_i$				\\
	$(V, E_{LR}, E_{RL}) \leftarrow \text{direct}(T)$				\\
