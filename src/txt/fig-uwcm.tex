...
\draw[] (2,1.3) -- (2.4,1.3) node[right]{\tiny $M$};
\draw[opt] (2,1) -- (2.4,1) node[right]{\tiny $M^*$};
\draw[p] (2,.7) -- (2.4,.7) node[right]{\tiny $P^M$};
\draw[d] (2,.4) -- (2.4,.4) node[right]{\tiny $D^M$};
\draw[f] (2,.1) -- (2.4,.1) node[right]{\tiny $F^M$};
