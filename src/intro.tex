...
that $\text{P} \neq \text{NP}$.
It is not clear, however, if nay of the technique used to address the
...
for the unweighted variant of the problem, finally in section~\ref{sec:cm} we
give a 3-approximation algorithm based on network flow.
